...
struct nodeRBTree *RB_Delete(struct nodeRBTree *T, struct nodeRBTree *z)
{
    ...
    if (y != z)
    {
        ...
        //copiar todos los campos de informacion
...
int main(){
    int totalCases, idCase, n, element, idElement, totalQueries, idQuery;
    int p, y;
    struct nodeRBTree *T = AssignNilLeaf(), *z, *prev, *succ;
